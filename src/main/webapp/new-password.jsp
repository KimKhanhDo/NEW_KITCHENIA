					...
					<div class="card text-black"">
						<div class="card-body p-md-5">
							<div class="row justify-content-center">
								...
								<!-- FORM start -->
								<form action="ResetPassword?action=SET_NEW_PASSWORD" method="POST" class="mx-1 mx-md-4">
									...
									<div class="form-row mb-4">
										<div class="col-md-12">
											<label class="form-label" for="form3Example4cd">Confirm New Password</label>
											 <input type="password" name="confPassword" id="reEnterPassword" class="form-control" required
									...
									<div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
										<button type="submit" class="btn btn-primary btn-lg"
											onclick="validateAgreement()">RESET</button>
									</div>
