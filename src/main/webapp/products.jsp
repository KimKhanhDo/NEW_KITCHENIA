            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
                        ...
                        <span>Elevate Your Culinary Experience with Kitchenia</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="item">
                        ...
                        <div class="down-content">
                            <h4>AYESHA CURRY</h4>
                            <span>Nonstick Bakeware Set</span>
                            <span>$59.99</span>
                            <ul class="stars">
                ...
                <div class="col-lg-4">
                    <div class="item">
                        ...
                        <div class="down-content">
                            <h4>AYESHA CURRY</h4>
                            <span>4-Piece Toaster Oven Baking Set</span>
                            <span>$59.99</span>
                ...
                <div class="col-lg-4">
                    <div class="item">
                        ...
                        <div class="down-content">
                            <h4>RACHAEL RAY</h4>
                            <span>Covered Cake Pan & Muffin Pan</span>
                            <span>$39.99</span>
                            <ul class="stars">
                                <li><i class="fa fa-star"></i></li>
                                <li><i class="fa fa-star"></i></li>
                ...
                <div class="col-lg-4">
                    <div class="item">
                        <div class="thumb">
                            ...
                            <img src="assets/images/cookware1.webp" alt="">
                        </div>
                        <div class="down-content">
                            <h4>KITCHENAID</h4>
                            <span>10-Piece Hard Anodized Ceramic Nonstick Cookware Set</span>
                            <span>$229.99</span>
                            <ul class="stars">
                                <li><i class="fa fa-star"></i></li>
                                <li><i class="fa fa-star"></i></li>
                ...
                <div class="col-lg-4">
                    <div class="item">
                        <div class="thumb">
                            ...
                            <img src="assets/images/cookware2.webp" alt="">
                        </div>
                        <div class="down-content">
                            <h4>AYESHA CURRY</h4>
                            <span>Stainless Steel 11-Piece Cookware Set</span>
                            <span>$149.99</span>
                            <ul class="stars">
                                <li><i class="fa fa-star"></i></li>
                                <li><i class="fa fa-star"></i></li>
                ...
                <div class="col-lg-4">
                    <div class="item">
                        <div class="thumb">
                            ...
                            <img src="assets/images/cookware3.webp" alt="">
                        </div>
                        <div class="down-content">
                            <h4>RACHAEL RAY</h4>
                            <span>Cucina 12-Piece Nonstick Cookware Set</span>
                            <span>$159.99</span>
                            <ul class="stars">
                                <li><i class="fa fa-star"></i></li>
                                <li><i class="fa fa-star"></i></li>
                ...
                <div class="col-lg-4">
                    <div class="item">
                        <div class="thumb">
                            ...
                            <img src="assets/images/cookware5.jpeg" alt="">
                        </div>
                        <div class="down-content">
                            <h4>LE CREUSET</h4>
                            <span>Signature French Oven Cerise 28cm</span>
                            <span>$750.00</span>
                            <ul class="stars">
                                <li><i class="fa fa-star"></i></li>
                                <li><i class="fa fa-star"></i></li>
